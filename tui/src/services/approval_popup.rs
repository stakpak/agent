...
impl PopupService {
    ...
    fn create_popup() -> PopupWidget {
        ...
        let tab2_content = StyledLineContent::new(vec![
            ...
            (
                Line::from(
                    "This is a very long line that should wrap around the popup content area and demonstrate how text wrapping works in the popup widget. The text should automatically wrap to the next line when it reaches the edge of the content area, making it easy to read long content without horizontal scrolling.",
                ),
                Style::default().fg(Color::White),
            ),
            (Line::from(""), Style::default()),
            ...
            (
                Line::from(
                    "Technical details about the popup widget implementation: The popup widget uses Ratatui's text rendering capabilities to handle text wrapping automatically. It supports styled text with different colors and modifiers, and can handle both short and long content efficiently. The scrolling functionality allows users to navigate through content that exceeds the visible area.",
                ),
                Style::default().fg(Color::Green),
            ),
            (Line::from(""), Style::default()),
            (
                Line::from(
                    "More test content to ensure scrolling works properly with wrapped text. This line is intentionally long to test the wrapping behavior and ensure that the popup widget can handle various types of content without issues. The text should wrap naturally and maintain readability.",
                ),
                Style::default().fg(Color::Magenta),
            ),
            (
            ...
            (
                Line::from(
                    "Line 14: And this line is even longer to test how the popup handles very long lines that might wrap around the screen",
                ),
                Style::default().fg(Color::Gray),
            ),
            (
        ...
        let tab3_content = StyledLineContent::new(vec![
            ...
            (Line::from(""), Style::default()),
            (Line::from("```rust"), Style::default().fg(Color::Gray)),
            (
            ...
            (Line::from("```"), Style::default().fg(Color::Gray)),
            (Line::from(""), Style::default()),
            (
        ...
        let config = PopupConfig::new()
            ...
            .selected_tab_style(Style::default().fg(Color::White).bg(Color::Magenta))
