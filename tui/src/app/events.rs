...
use stakpak_shared::models::{
    agent_runtime::{ToolCallResult, ToolCallResultProgress, ToolCallStreamInfo},
    llm::LLMTokenUsage,
};
use uuid::Uuid;
...
pub enum InputEvent {
    ...
    MessageToolCalls(Vec<stakai::ToolCall>),
    ScrollUp,
    ScrollDown,
    PageUp,
    PageDown,
    ...
    ToggleCursorVisible,
    Resized(u16, u16),
    ShowConfirmationDialog(stakai::ToolCall),
    HasUserMessage,
    Tab,
    ...
    ShowAskUserPopup(
        stakai::ToolCall,
        Vec<stakpak_shared::models::agent_runtime::AskUserQuestion>,
    ),
    AskUserNextTab,
    AskUserPrevTab,
    AskUserNextOption,
...
pub enum OutputEvent {
    ...
    UserMessage(
        ...
        Vec<stakai::ContentPart>,
        Option<usize>, // revert_to_user_message_index
    ),
    AcceptTool(stakai::ToolCall),
    RejectTool(stakai::ToolCall, bool),
    ListSessions,
    SwitchToSession(String),
    NewSession,
    SendToolResult(ToolCallResult, bool, Vec<stakai::ToolCall>),
    ResumeSession,
