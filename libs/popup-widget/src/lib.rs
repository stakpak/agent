...
impl Default for PopupConfig {
    fn default() -> Self {
        Self {
            ...
            title_style: Style::default().fg(Color::White).add_modifier(ratatui::style::Modifier::BOLD),
            ...
            selected_tab_style: Style::default().fg(Color::Yellow).add_modifier(ratatui::style::Modifier::BOLD),
            tab_borders: false,
...
impl PopupConfig {
    ...
    pub fn title_color(mut self, color: Color) -> Self {
        self.title_style = Style::default().fg(color).add_modifier(ratatui::style::Modifier::BOLD);
        self
    }
...
mod tests {
    ...
    fn test_popup_widget_creation() {
        let config = PopupConfig::new()
            .title("Test")
            .position(PopupPosition::Centered { width: 40, height: 10 });
    ...
    fn test_styled_line_content() {
        ...
        let lines = vec![
            ...
            (Line::from("World"), Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
        ];
